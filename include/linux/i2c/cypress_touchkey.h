...
#if defined(CONFIG_MACH_S3VE) || defined(CONFIG_MACH_S3VECTC)
...
#if defined(CONFIG_KEYBOARD_CYPRESS_TOUCH_20055)
#define PM8921_IRQ_BASE			(NR_MSM_IRQS + NR_GPIO_IRQS)
#define IRQ_TOUCHKEY_INT 	24
#define GPIO_TOUCHKEY_SDA	55
#define GPIO_TOUCHKEY_SCL	56
#define GPIO_TOUCHKEY_SCL_2	56
//#define PMIC_GPIO_TKEY_INT	79
#define PMIC_GPIO_TKEY_EN	2
#define PMIC_GPIO_TKEY_EN2	3

#elif defined(CONFIG_MACH_S3VE) || defined(CONFIG_MACH_S3VECTC)
//#define IRQ_TOUCHKEY_INT	49
#define GPIO_TOUCHKEY_SDA	100
#define GPIO_TOUCHKEY_SCL	99
#else
#define PM8921_IRQ_BASE			(NR_MSM_IRQS + NR_GPIO_IRQS)
