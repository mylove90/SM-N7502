...
/* for HA */
#define FW_PATH "tkey_cypress/cypress_hl.fw"
...
/* LCD Type check*/
#if defined(CONFIG_HA) || defined(CONFIG_MACH_HLLTE) || defined(CONFIG_MACH_HL3G) //  defined(CONFIG_KEYBOARD_CYPRESS_TOUCH_20055)
...
#if defined(CONFIG_MACH_HLLTE) || defined(CONFIG_MACH_HL3G) // || defined(CONFIG_KEYBOARD_CYPRESS_TOUCH_20055)
