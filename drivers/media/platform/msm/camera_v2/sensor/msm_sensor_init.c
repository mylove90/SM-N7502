			...
			struct device_attribute *attr, char *buf)
{
	...
	char cam_fw[] = "B08QTGJ01MK B08QTGJ01MK\n";
	return snprintf(buf, sizeof(cam_fw), "%s", cam_fw);
#elif defined(CONFIG_MACH_CS03_SGLTE)
		char cam_fw[] = "B08QTGJ01ML B08QTGJ01ML\n";
		return snprintf(buf, sizeof(cam_fw), "%s", cam_fw);
...
#elif defined(CONFIG_MACH_CRATERQ)
	char cam_fw[] = "SR200PC20 SR200PC20\n";
#elif defined(CONFIG_MACH_CS03_SGLTE)
	char cam_fw[] = "NULL NULL\n";
